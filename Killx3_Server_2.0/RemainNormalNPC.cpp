...
CRemainNormalNPC::CRemainNormalNPC(WORD ID, Vec3 _InitPos, float _Speed, BYTE _MoveState,
...
CRemainNormalNPC::~CRemainNormalNPC() {}

void CRemainNormalNPC::SetID(int _ID) {
	m_ID = _ID;
}
Vec3 CRemainNormalNPC::GetPos() { return m_Position; }
bool CRemainNormalNPC::GetAlive() { return m_alive; }
Vec3 CRemainNormalNPC::GetInitPos() { return m_InitPos; };

void CRemainNormalNPC::Update(float DeltaTime, HANDLE _hIOCP, CLIENT * p_Clients, const int& ID1, const int& ID2)
{
	if (m_HP <= 0)
		m_alive = false;
...
void CRemainNormalNPC::SetDestPoint(Vec3 _DestVec3) {
	DestPoint.push(_DestVec3);
}
void CRemainNormalNPC::SetAniState(BYTE _Ani)
{
	m_AnimationState = _Ani;
}
void CRemainNormalNPC::SetHP(int _Hp)
{
	m_HP -= _Hp;
}
void CRemainNormalNPC::SetBackDist(float dist)
{
	m_BackDist = dist;
}
void CRemainNormalNPC::SetRemove(bool remove)
{
	m_Remove = remove;
}
void CRemainNormalNPC::SetMapType(BYTE map)
{
	m_MapType = map;
}
queue<Vec3> CRemainNormalNPC::GetDestPoint() {
	return DestPoint;
}
void CRemainNormalNPC::SetDir(Vec3 _Dir) {
	m_Direction = _Dir;
}
void CRemainNormalNPC::SetSpeed(float _Speed)
{
	MonsterSpeed = _Speed;
}
void CRemainNormalNPC::SetRoomNumber(int _RoomNumber) {
	RoomNumber = _RoomNumber;
}
int CRemainNormalNPC::GetRoomNumber() {
	return RoomNumber;
}
BYTE CRemainNormalNPC::GetAniState()
{
	return m_AnimationState;
}
int CRemainNormalNPC::GetHP()
{
	return m_HP;
}
float CRemainNormalNPC::GetBackDist()
{
	return m_BackDist;
}
bool CRemainNormalNPC::GetRemove()
{
	return m_Remove;
}
Vec3 CRemainNormalNPC::GetDir() {
	return m_Direction;
}

float CRemainNormalNPC::GetSpeed()
{
	return MonsterSpeed;
}
